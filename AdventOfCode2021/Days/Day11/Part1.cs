namespace AdventOfCode2021.Days.Day11
{
    ...
    {
        public override ulong Apply(string[] input) => CountFlashes(input);

        public static ulong CountFlashes(string[] input) => CountFlashes(Parse(input));
        ...
        public static ulong CountFlashes(byte[,] state) => Enumerable.Range(0, 100).Aggregate((ulong)0, (a, _) => SimulateRound(state, a));

        public static ulong SimulateRound(byte[,] state, ulong flashCount)
        {
